...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'objectStacks', 1, 20).onChange(this.scene.updateObjectStacks.bind(this.scene));
        this.gui.add(this.scene, 'globalAmbientLight', 0.01, 1.0).onChange(this.scene.updateGlobalAmbientLight.bind(this.scene));
