...
export class MyScene extends CGFscene {
    ...
    updateObjectStacks(){
        this.objects[this.selectedObject].updateStacks(this.objectStacks);
    }
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(150/255,111/255,51/255, 1.0);
        this.material4.setDiffuse(150/255,111/255,51/255, 1.0);
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Lumber': 3, 'Custom': 4 };
    }
    display() {
