...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'isFlying').name('Fly bird, fly');        

        this.gui.add(this.scene, 'selectedObject', this.scene.objectIDs).name('Selected Object').onChange(this.scene.restoreVariables.bind(this.scene));
